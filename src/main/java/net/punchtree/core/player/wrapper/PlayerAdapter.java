package net.punchtree.core.player.wrapper;
...
public class PlayerAdapter implements Player {
	...
	public boolean removeScoreboardTag(@NotNull String tag) {
		return removeScoreboardTag(tag);
	}
	...
	@Override
	public boolean spawnAt(@NotNull Location location, @NotNull SpawnReason spawnReason) {
